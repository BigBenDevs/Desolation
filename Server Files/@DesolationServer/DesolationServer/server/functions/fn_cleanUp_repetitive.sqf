scriptName "fn_cleanUp_repetitive";
/*--------------------------------------------------------------------
	Author: OPTiX (ofpectag: OPX)
    File: fn_cleanUp_repetitive.sqf
...
--------------------------------------------------------------------*/
#define __filename "fn_cleanUp_repetitive.sqf"

// Parameters


// Exceptions
if (true) exitWith {}; // DISABLED
...
_ttdBodies = 5*60; // seconds to delete dead bodies (0 means don't delete)
